...
import { generateInsulinTimelineData } from '../utils/insulinUtils';
import TimeInput from '../components/TimeInput';
import { FaSync, FaChartBar, FaTable, FaList, FaFilter, FaCalendarAlt, FaInfoCircle, FaSyringe } from 'react-icons/fa';
...
{showBloodSugar && showMealEffect && showTargetMealEffect && (
  ...
  const renderMealDetail = () => {
    ...
    try {
      ...
      mealEffects = calculateBGImpactCurve({
  nutrition: {
    carbs: carbs,
    protein: protein,
    fat: fat,
