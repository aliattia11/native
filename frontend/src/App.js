...
import GlycemicResponseTracker from './components/GlycemicResponseTracker'; // Add the import for MealVisualization
import './App.css';
            ...
            <div className="App">
              <Routes>
                ...
                <Route path="/meal-history" element={
                  loggedIn ? <GlycemicResponseTracker /> : <Navigate to="/login" />
                } />
                ...
                <Route path="/patient/:patientId/meal-history" element={
                  loggedIn && userType === 'doctor' ?
                    <GlycemicResponseTracker isDoctor={true} /> :
                    <Navigate to="/login" />
                } />
