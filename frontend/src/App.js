...
import SimpleMealEffectChart from './components/SimpleMealEffectChart'; // Add the import for MealVisualization
import './App.css';
            ...
            <div className="App">
              <Routes>
                ...
                <Route path="/meal-history" element={
                  loggedIn ? <SimpleMealEffectChart /> : <Navigate to="/login" />
                } />
                ...
                <Route path="/patient/:patientId/meal-history" element={
                  loggedIn && userType === 'doctor' ?
                    <SimpleMealEffectChart isDoctor={true} /> :
                    <Navigate to="/login" />
                } />
